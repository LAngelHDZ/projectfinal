    ...
    <div class="row ">
        <div class="col-lg-8 flex-column align-items-end min-vh-100 mx-auto">
            <div class="align-self-center w-100 px-lg-5 py-lg-4 p-4">
                ...
                <form  action="{{route('updateformC',$curso[0]->id)}}"  method="POST" class="mb-5">
                    @csrf
                    @method('patch')
                            <div class="mb-4">
                                ...
                                <select name="docente" id="" class="form-control bg-dark-x border-0 mb-2">
                                    <option value="{{$curso[0]->docente_id}}" selected>{{ $curso[0]->docente_id.'.- '.$curso[0]->name.' '.$curso[0]->apellidoP.' '.$curso[0]->apellidoM}}</option>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="materia" id="" class="form-control bg-dark-x border-0 mb-2">
                                    <option value="{{$curso[0]->materia_id}}" selected>{{$curso[0]->materia_id.'.-'.$curso[0]->materia}}</option>
