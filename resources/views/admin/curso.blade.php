...
<div class="container">
    <div class="d-flex flex-row-reverse my-2  ">
          <a class="btn btn-secondary px-4  text-decoration-none " href="{{ route('registrarCurso') }}">
        ...
        <table class="table">
          ...
          @endphp
              ...
              <tr>
                ...
                <td class="px-3">
                  <a href="{{ route('updateCurso',$curso->id) }}" class="btn btn-link py-1">
                ...
                <td class="px-4">
                  <form method="POST" action="{{ route('cursodel') }}">
                    @csrf
                    @method('delete')
