...
<div class="container">
    <div class="d-flex flex-row-reverse my-2  ">
          <a class="btn btn-secondary px-4  text-decoration-none " href="{{ route('registrarDocente') }}">
        ...
        <table class="table">
          ...
          @endphp
              ...
              <tr>
                ...
                <td class="px-3">
                  <a href="{{ route('updateDocente',$docente->id) }}" class="btn btn-link py-1">
                ...
                <td class="px-4">
                  <form method="POST" action="{{ route('docentedel') }}">
                    @csrf
                    @method('delete')
                    <input type="hidden" name="idD" value="{{$docente->id}}">
                    <input type="hidden" name="idU" value="{{$docente->id_user}}">
