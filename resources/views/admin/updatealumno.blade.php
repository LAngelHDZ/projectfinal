    ...
    <a class='border border-primary py-2 px-3 ' href="{{ route('alumno') }}">
        ...
        <div class="col-lg-12 flex-column align-items-end min-vh-100 mx-auto">
            <div class="align-self-center w-100 px-lg-5 py-lg-4 p-4">
                <h1 class="font-weight-bold mb-4 text-dark  text-center">Actualizar alumno</h1>
                    ...
                    <div class="row g-0 ">
                        <div class="col col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="hidden" name="idA" value="{{$alumno->id}}">
                                <label  class="form-label font-weight-bold text-dark">Nombre</label>
                                <input type="text" name="nombre" pattern="[A-Z a-z]{2,15}" class="form-control bg-dark-x border-0"  value="{{$user[0]->name}}" >
                            </div>
                            <div class="mb-4">
                                <label  class="form-label font-weight-bold text-dark">Apellido paterno</label>
                                <input type="text" name="ap" class="form-control bg-dark-x border-0 mb-2" value="{{$user[0]->apellidoP}}">
                            </div>
                            <div class="mb-4">
                                <label  class="form-label font-weight-bold text-dark">Apellido materno</label>
                                <input type="text" name="am" class="form-control bg-dark-x border-0"  value="{{$user[0]->apellidoM}}" >
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="col col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="matricula" class="form-control bg-dark-x border-0 mb-2" value="{{$alumno->matricula}}" >
                            </div>
                            <div class="mb-4">
